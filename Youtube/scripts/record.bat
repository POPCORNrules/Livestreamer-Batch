...
set /p "channel=What is the name of the Youtube video you want to Record?: "
...
:end
cls
start cmd /c %TP%\Youtube\scripts\play.bat
livestreamer.exe %channel% %quality% -l none -o "%save%\Youtube_%mydate%_%mytime%.mp4"

cls
set "svdir=%save%\Youtube_%mydate%_%mytime%.mp4"
